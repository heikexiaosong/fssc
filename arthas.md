...
watch cn.ztessc.service.provide.FmsProvideRepayPlanService saveInterestPlanNew "{params, returnObj}" -b -x 3
...
watch cn.ztessc.util.InterestPlanGenerator generateInterestPlanDates "{params, returnObj}" -s -x 3

...
通过放款ID生成还息计划
- /sys/fms/fmsProvideRepayPlan/generateRepaymentPlan/332fa8f203147c5605913139322e56a1
...
### 生成还息计划(带时间)
通过放款ID生成还息计划
- /sys/fms/fmsProvideRepayPlan/generateRepaymentPlanNew/332fa8f203147c77c7cc3139322e571a
- cn.ztessc.controller.provide.FmsProvideRepayPlanController#generateRepaymentPlanNew
```json
{
    "repayPlanConfirmedMsg": [
        "INTEREST_PLAN_ALREADY_EXISTS"
    ],
    "accrualStartDate": "2025-10-09"
}
```
...
-- 放款记录（融资贷款）
-- provideLoanEntity
select * from FMS_PROVIDE_LOAN where id = '332fa8f203147c77c7cc3139322e571a' and enabled_flag = '0'

-- 贷款记录  id = FMS_PROVIDE_LOAN::PROVIDE_HEADER_ID
-- fmsProvideHeaderEntity
select * from FMS_PROVIDE_HEADER where id =  '7138bbd96d42449cf99c3139322e5f25' and enabled_flag = '0'
